...
/**
 * Utilities to load configuration, message ids, etc from the cfs registry. While the intent with the registry is to
 * make it format-agnostic, at the moment only YAML is supported.
 * 
 * @author lgomez
 *
 */
...
public class RegistryUtil {
     ...
     */
    private static void getAllConfiguration(LinkedHashMap<?, ?> modules,
            LinkedHashMap<Object, Object> outConfiguration) {
    ...
    public LinkedHashMap<Object, Object> getAllConfig(String yamlPath) throws Exception {
        ...
        LinkedHashMap<?, ?> wholeRegistry = (LinkedHashMap<?, ?>) (LinkedHashMap<?, ?>) loadModulesFromYAML(yamlPath);
    ...
    /**
     * 
     * @return All of the configuration from the specified app stored in the registry in the following format:
     * 
     *         { cfe_es: { CFE_ES_CDS_MAX_NAME_LENGTH={name=CFE_ES_CDS_MAX_NAME_LENGTH, value=16} }, }. If the no
     *         configuration exists for the app, null is returned. Not that it is possible for this function to return
     * 
     * 
     * 
     * @throws Exception
    ...
    private static void getAllTelemetry(LinkedHashMap<?, ?> modules, LinkedHashMap<Object, Object> outMsgIds) {
        for (Map.Entry<?, ?> moduleSet : modules.entrySet()) {
            LinkedHashMap<?, ?> module = ((LinkedHashMap<?, ?>) modules.get(moduleSet.getKey()));
    ...
    private static void getAllTeleCommands(LinkedHashMap<?, ?> modules, LinkedHashMap<Object, Object> outCmdMsgIds) {
        for (Map.Entry<?, ?> moduleSet : modules.entrySet()) {
            LinkedHashMap<?, ?> module = ((LinkedHashMap<?, ?>) modules.get(moduleSet.getKey()));
    ...
    /**
     * Get all messages from the registry from a specific app. This includes commands and telemetry messages.
     * 
     * @return A map of messages in the following format: { HK_HK_TLM_MID: { msgID: 2158, type: TELEMETRY, macro:
     *         HK_HK_TLM_MID, app: hk }, HK_SEND_COMBINED_PKT_MID: { msgID: 6256, commands: {SendCombinedPkt={cc=0}},
     *         type: COMMAND, macro: HK_SEND_COMBINED_PKT_MID, app: hk } }
     * @throws Exception
     */
    public static LinkedHashMap<Object, Object> getAllMessagesForApp(String yamlPath, String appName) throws Exception {
        ...
        for (Entry<?, ?> mEntry : messages.entrySet()) {
            LinkedHashMap<Object, Object> msgMap = (LinkedHashMap<Object, Object>) messages.get(mEntry.getKey());
    ...
    /**
     * Convenience function to map all messages to Macros directly. Very useful for sending messages that have
     * messageIds to clients.
     * 
     * @param messages
     *            A map that is assumed to be in the format of {@code { CFE_ES_CMD_MID={msgID=6148,
     *            commands={Noop={cc=0}, Reset={cc=1}, Restart={cc=2}, type=COMMAND, macro=CFE_ES_CMD_MID, app=cfe_es},
     *            CFE_ES_HK_TLM_MID={msgID=2063, type=TELEMETRY, macro=CFE_ES_HK_TLM_MID, app=cfe_es},
     *            CFE_ES_APP_TLM_MID={msgID=2071, type=TELEMETRY, macro=CFE_ES_APP_TLM_MID, app=cfe_es},
     *            CFE_ES_MEMSTATS_TLM_MID={msgID=2076, type=TELEMETRY, macro=CFE_ES_MEMSTATS_TLM_MID, app=cfe_es},
     *            CFE_ES_SHELL_TLM_MID={msgID=2075, type=TELEMETRY, macro=CFE_ES_SHELL_TLM_MID, app=cfe_es}} } }
     * 
     * @return A new map in the form of {@code {CFE_ES_CMD_MID=6148, CFE_ES_SEND_HK_MID=6149, CFE_ES_HK_TLM_MID=2063,
     *         CFE_ES_APP_TLM_MID=2071, CFE_ES_MEMSTATS_TLM_MID=2076, CFE_ES_SHELL_TLM_MID=2075} }
     */
    public static LinkedHashMap<Object, Object> getMacroToMsgIdMap(LinkedHashMap<Object, Object> messages) {
        LinkedHashMap<Object, Object> outMap = new LinkedHashMap<Object, Object>();

        for (Entry<?, ?> mEntry : messages.entrySet()) {
            LinkedHashMap<Object, Object> messageMap = (LinkedHashMap<Object, Object>) messages.get(mEntry.getKey());
     ...
     *            CFE_ES_SHELL_TLM_MID={msgID=2075, type=TELEMETRY, macro=CFE_ES_SHELL_TLM_MID, app=cfe_es}} } }
     * 
     * @return A new map in the form of {@code {6148=CFE_ES_CMD_MID, 6149=CFE_ES_SEND_HK_MID, 2063=CFE_ES_HK_TLM_MID,
     *         2071=CFE_ES_APP_TLM_MID, 2076=CFE_ES_MEMSTATS_TLM_MID, 2075=CFE_ES_SHELL_TLM_MID} }
     */
    public static LinkedHashMap<Object, Object> getMsgIdMapToMacro(LinkedHashMap<Object, Object> messages) {
        LinkedHashMap<Object, Object> outMap = new LinkedHashMap<Object, Object>();
