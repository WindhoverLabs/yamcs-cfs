 ...
 *
 */
public class RFC1661PacketInputStream implements PacketInputStream {
    ...
    public void init(InputStream inputStream, YConfiguration args) {
        ...
        eventProducer = EventProducerFactory.getEventProducer(null,
                RFC1661PacketInputStream.class.getName(), 0);
    ...
    public byte[] readPacket() throws IOException {
        byte RFCData[] = new byte[12];
        
        System.out.println("data from RFC1661 BEFORE");
        
        dataInputStream.readFully(RFCData, 0, 12);  
        
        String s = new String(RFCData, StandardCharsets.UTF_8);
       
        System.out.println("data from RFC1661:" + s);
