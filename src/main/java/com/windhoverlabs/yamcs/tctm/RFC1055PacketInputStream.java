...
public class RFC1055PacketInputStream implements PacketInputStream {
  ...
  private static final byte ESC = (byte) 0x0333;
  private final byte ESC_END = (byte) 0x0334;
  private final byte ESC_ESC = (byte) 0x0335;
  ...
  protected byte[] getPayload(DataInputStream data) throws IOException {
    ...
    RF_STATE currentState = RF_STATE.END;
    ...
    while (true) {
      ...
      currentState.setStateValue(c[0]);
