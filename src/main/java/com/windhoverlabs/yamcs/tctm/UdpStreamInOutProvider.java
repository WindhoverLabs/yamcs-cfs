 ...
 * @author nm
 */
public class UdpStreamInOutProvider extends AbstractYamcsService implements Link, StreamSubscriber, SystemParametersProducer, Runnable {
    String host;
...
//  private volatile int invalidDatagramCount = 0;
    ...
    protected void processPacket(TmPacket tmpkt) {
        ...
        byte[] trimmedByteArray = Arrays.copyOfRange(byteArray, this.offset, byteArray.length - this.rightTrim);
