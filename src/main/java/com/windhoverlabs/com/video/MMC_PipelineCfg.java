...
public class MMC_PipelineCfg {
    ...
    public static final int MMC_MAX_HW_ACCEL_DEVICE_ID_LENGTH = 128; // Example value, replace with actual
    public static final int MMC_MAX_CONFIG_PARAMS = 10; // Example value, replace with actual

    // Enums
    public enum MMC_AVComponentType {
        AV_UNKNOWN(0),
        AV_INPUT_FORMAT(1),
        AV_ENCODER(2),
        AV_FILTER(3),
