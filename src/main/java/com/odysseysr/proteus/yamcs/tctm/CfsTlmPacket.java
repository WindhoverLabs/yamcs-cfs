...
public class CfsTlmPacket implements Comparable<CfsTlmPacket>{
	...
	public long getInstant() {
        ...
        switch(timestampFormat) {
        	case CFE_SB_TIME_32_16_SUBS:
        		instant = TimeEncoding.fromGpsCcsdsTime(bb.getInt(6), bb.get(8)) ;
        		break;
        		
        	case CFE_SB_TIME_32_32_SUBS:
        		instant = TimeEncoding.fromGpsCcsdsTime(bb.getInt(6), bb.get(10)) ;
        		break;
	...
	public int getFineTime() {
        ...
        switch(timestampFormat) {
        	case CFE_SB_TIME_32_16_SUBS: {
        		short shortFineTime = bb.getShort(10); // & (short)0xFFFF;
